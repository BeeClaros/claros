    ...
    case "cell":
      return (
        <svg {...s} viewBox="0 0 34 34" fill="none" stroke={stroke} strokeWidth="1.5" aria-hidden="true">
          ...
          <circle cx="17" cy="17" r="3.2" fill="var(--v8-lime)" stroke="none" />
        </svg>
      );
    case "trajectory":
      return (
        <svg {...s} viewBox="0 0 34 34" fill="none" stroke={stroke} strokeWidth="1.5" aria-hidden="true">
          ...
          <circle cx="31" cy="7" r="2.6" fill="var(--v8-lime)" stroke="none" />
        </svg>
      );
    case "wing":
      return (
        <svg {...s} viewBox="0 0 34 34" fill="none" stroke={stroke} strokeWidth="1.5" aria-hidden="true">
          ...
          <circle cx="17" cy="6" r="2.2" fill="var(--v8-lime)" stroke="none" />
        </svg>
      );
    case "link":
      return (
        <svg {...s} viewBox="0 0 34 34" fill="none" stroke={stroke} strokeWidth="1.5" aria-hidden="true">
          ...
          <circle cx="7" cy="17" r="1.6" fill="var(--v8-lime)" stroke="none" />
        </svg>
      );
    case "module":
      return (
        <svg {...s} viewBox="0 0 34 34" fill="none" stroke={stroke} strokeWidth="1.5" aria-hidden="true">
          ...
          <rect x="11.5" y="19" width="11" height="11" fill="var(--v8-lime)" fillOpacity="0.9" stroke="none" />
    ...
    default:
      return (
        <svg {...s} viewBox="0 0 34 34" fill="none" stroke={stroke} strokeWidth="1.5" aria-hidden="true">
          ...
          <circle cx="17" cy="17" r="3.4" fill="var(--v8-lime)" stroke="none" />
        </svg>
      );
  }
}
      ...
      <div className="v8-container">
        <div className="v8-grid" style={{ rowGap: "2rem" }}>
          <div style={{ gridColumn: "1 / -1", maxWidth: "48rem" }}>
            <div className="v8-overline v8-reveal">Where we help</div>
            <h2
        ...
        <div className="va-grid" style={{ marginTop: "clamp(2.5rem, 5vw, 4rem)" }}>
          {AREAS.map((area, i) => (
            <a
              key={area.title}
              href="#contact"
              className={`v8-cell va-item v8-reveal v8-reveal-${(i % 3) + 1}`}
            >
              <div className="v8-cell-mark" style={{ marginBottom: "1.25rem" }}>
                <Mark type={area.mark} />
              </div>
              <h3
              ...
              <p className="v8-body" style={{ marginTop: "0.7rem", fontSize: "0.98rem" }}>
                {area.copy}
              </p>
            </a>
          ))}
